...
public class ChatbotService {
    ...
    private String generateGeminiResponse(String userMessage) {
        try {
            ...
            String systemInstructions = "You are 'Care Connect AI', a professional medical assistant. " +
                    "Analyze symptoms and provide: 1. Cause, 2. Precautions, 3. OTC Meds, 4. Specialist. " +
                    "Use HTML (<b>, <br>, •). Keep advice general.";
            ...
            return "ERROR_FROM_GEMINI: Empty response from Google";
        } catch (Exception e) {
    ...
    private String generateAIResponseMock(String message, String geminiError) {
        ...
        if ((lowerMsg.contains("pain") || lowerMsg.contains("hurt") || lowerMsg.contains("ache")) && 
            ...
            response = "<div style='line-height:1.5;'><b>🚑 Possible Cause:</b> Muscle strain or sprain.<br><br><b>🛡️ Precautions:</b> Rest and ice.</div>";
        } else if (lowerMsg.contains("stomach") || lowerMsg.contains("belly")) {
            response = "<div style='line-height:1.5;'><b>🚑 Possible Cause:</b> Indigestion or gas.<br><br><b>🛡️ Precautions:</b> Hydrate and rest.</div>";
        } else if (lowerMsg.contains("fever") || lowerMsg.contains("cold") || lowerMsg.contains("headache")) {
            response = "<div style='line-height:1.5;'><b>🚑 Possible Cause:</b> Viral infection.<br><br><b>🛡️ Precautions:</b> Rest and Paracetamol.</div>";
        } else if (lowerMsg.contains("skin") || lowerMsg.contains("rash") || lowerMsg.contains("allergy")) {
            response = "<div style='line-height:1.5;'><b>🚑 Possible Cause:</b> Allergic reaction.<br><br><b>🛡️ Precautions:</b> Anti-itching cream.</div>";
        } else {
            response = "<div style='line-height:1.5;'><b>🤖 AI Assistant:</b> Please describe your symptoms more clearly.</div>";
        }
